...
CFLAGS="-Wall -Wextra -pedantic -ggdb -DGLEW_STATIC `pkg-config --cflags $PKGS` -Isrc -Idependencies/miniconf -Idependencies/minifmt -Idependencies/minirent -Dassert(expression)=((void)0) "
